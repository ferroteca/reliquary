...
class SpecifiedPhaseTests(unittest.TestCase):
    ...
    machine-readable norm, and the literals `machines.py` writes
    must be members. Whether the prose in `instance-model.md`
    matches the schema is R8's audit (planning/RECURRING.md) —
    the schema is the artifact this suite consumes.
    """
