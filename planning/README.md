...
| [`pledged/design/`](pledged/design/) | Design for pledged features — empty today; a delivered feature leaves no feature for its design to sit with, so its design travels out with the delivery |
