...
| [`pledged/design/`](pledged/design/) | Design for pledged features — `landmarks.md` (F65, and the F5 remainder's pointer half references it); a delivered feature leaves no feature for its design to sit with, so its design travels out with the delivery |
