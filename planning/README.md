...
| [`proposed/design/`](proposed/design/) | Design for proposed features — `landmarks.md` (F5), `pointer-input.md` (F5), `device-growth.md` (F5), `hyperv-screen.md` (F5), `recorder.md` (F1, U6), `platform-dialect.md` (F64) |
