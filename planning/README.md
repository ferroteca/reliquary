...
| [`pledged/design/`](pledged/design/) | Design for pledged features — `vnc-plane.md` (F63); a delivered feature leaves no feature for its design to sit with, so its design travels out with the delivery |
