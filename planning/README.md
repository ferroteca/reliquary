...
| [`pledged/design/`](pledged/design/) | Design for pledged features — `screen-transcripts.md` (F42, F43); a delivered feature leaves no feature for its design to sit with, so its design travels out with the delivery |
