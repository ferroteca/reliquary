...
- **The next D-number to issue is D97** — decisions, recorded in
  [DECISIONS.md](DECISIONS.md).
- **The next F-number to issue is F35** — features, drafted in
...
- **The next U-number to issue is U23** — use cases, one namespace
  across proposed, pledged, and the root list.
- **The next V-number to issue is V16** — the script language's
