...
- **The next D-number to issue is D102** — decisions, recorded in
  [DECISIONS.md](DECISIONS.md).
- **The next F-number to issue is F53** — features, drafted in
...
- **The next S-number to issue is S9** — application surfaces
  ...
  surfaces").
- **The next T-number to issue is T14** — tasks, entering
